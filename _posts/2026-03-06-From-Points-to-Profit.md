---
title: "From 'Points' to Profit: Un-Enshittifying the 3D Design Economy"
date: 2026-03-06
author: Jeff Barrows
...
# From "Points" to Profit: Un-Enshittifying the 3D Design Economy
...
At LMNT, we believe the only way to fix the design economy is to fix the plumbing. We have to move from an economy based on *insecure downloads* to one based on *secure, pay per-print model*.
...
This isn't just a minor optimization; it's a paradigm shift. It allows a designer to move from being a \"file sharer\" competing for algorithmic attention to running a professional, high-margin production studio.
...
Professional engineers, industrial designers, and niche hobbyists who currently keep their best work siloed on local hard drives will finally have a safe, profitable marketplace. We will see a massive influx of high-utility models: custom tooling, repair parts, specialized drone frames, and professional-grade functional assemblies.

We aren't just trying to build a better tip jar for articulated dragons. We are building the secure rails necessary to transition 3D printing from a hobbyist 'sharing economy' into a distributed, global manufacturing network.

It's time to stop farming points, get off the Patreon treadmill, and start building businesses.

---
*Jeff Barrows is a Senior Engineering Manager and Technical Advisor at [LMNT Marketplace](https://lmnt.co). He is focused on building the secure economic infrastructure for the next generation of decentralized manufacturing.*
